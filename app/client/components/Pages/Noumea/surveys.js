export const surveys = [
  {
    "id": 1,
    "title": "1.1 Usage temporaire de l'ancien complexe Gaston-Bourret",
    "description": "L’ancien site de l’hôpital Gaston-Bourret est composé de 26 bâtiments,\
    ...
    "map": "./images/survey-map-immediat-1.png",
    "note": "Notez les differents programmes que nous proposons!",
    "questions": [
      {
        "id": 1,
        ...
        "id": 4,
        "text": "Espace à usage pluriel"
      },{
        "id": 5,
        "text": "Friche artistique-studios"
      },{
        "id": 6,
        "text": "Espace recherche scientifique"
      },{
        "id": 7,
        "text": "Café"
      },{
        ...
        "id": 9,
        "text": "Espaces verts et jardins potagers"
      },{
        "id": 10,
        "text": "Bâtiments fermés au public pour réhabilitation"
      },{
        "id": 11,
        "text": "Maison du projet (accueil/ exposition)"
      }
    ]
  }, {
    "id": 2,
    "title": "1.2 Usage temporaire du parking et du terrain vague adjacent",
    "description": "Coincé entre le mur de soutènement de l’ancien hôpital et la voie express 1, le parking Gaston-Bourret est peu utilisé.\
    ...
    "map": "./images/survey-map-immediat-2.png",
    "note": "Notez les differents programmes que nous proposons! Donnez nous votre avis sur chacun!",
    "questions": [
      {
        "id": 1,
        "text": "Jardinières mobiles"
      },{
        "id": 2,
        "text": "Stands restauration rapide / stand glacier"
      },{
        "id": 3,
        "text": "Espace camionnettes restauration - Food truck"
      },{
        "id": 4,
        "text": "Aire de jeux enfants"
      },{
        "id": 5,
        "text": "Parasols géants"
      },{
        "id": 6,
        "text": "Espace skateboard"
      },{
        "id": 7,
        "text": "Mur végétal anti-bruit"
      },{
        "id": 8,
        "text": "Surfaces peintes toiles géantes pour artistes"
      },{
        "id": 9,
        "text": "Zones vertes créées par percement de l’asphalte et zones pique-nique"
      },{
        "id": 10,
        "text": "Espace marchés éphémères (parvis + tables)"
      },{
        "id": 11,
        "text": "Jardins potagers dans jardinières mobiles"
      },{
        "id": 12,
        "text": "Trellis avec hamacs"
      },{
        "id": 13,
        "text": "Mobilier urbain reconfigurable"
      }
    ]
  }, {
    "id": 3,
    "title": "Circulations",
    "description": "La voie express 1 et la voie camion SLN longeant le front de mer contribuent à couper l’entrée nord u littoral et de la Grande Rade.\
    ...
    "map": "./images/survey-map-circulations.png",
    "note": "Notez les differents modes de circulations que nous proposons + donnez nous votre avis sur chacun!",
    "questions": [
      {
        "id": 1,
        "text": "Voie express #1 déplacée"
      },{
        "id": 2,
        "text": "Voie Néobus retracée et réaménagée + stations"
      },{
        "id": 3,
        "text": "Voie Karai bus + stations"
      },{
        "id": 4,
        "text": "Voie bus + station SMTI"
      },{
        "id": 5,
        "text": "Voie tchou-tchou train"
      },{
        "id": 6,
        "text": "Voie cyclable + Vélib"
      },{
        "id": 7,
        "text": "Voie piétonne"
      },{
        "id": 8,
        "text": "Connections piétonne"
      },{
        "id": 9,
        "text": "Passerelle végétalisée principale"
      },{
        "id": 10,
        "text": "Parking verticaux vertes (P.V.V.)"
      }
    ]
  }, {
    "id": 4,
    "title": "Espaces publiques/ espaces verts",
    "description": "Notre vision pour l’entrée nord à l’échelle du centre ville et de ses environs urbains vise à la désenclaver et à l’ouvrir non\
    ...
    "map": "./images/survey-map-public.png",
    "note": "3.1 Que pensez vous du placement et des identités de chaque espace vert/espace publique que nous proposons?",
    "questions": [
      {
        "id": 1,
        "text": "Bâtiment multifonctionnel (École de danse, bureaux, hôtel, ...)"
      },{
        "id": 2,
        "text": "Résidentiel avec commerce au RDC"
      },{
        "id": 3,
        "text": "Parking verticaux vertes (avec commerce, sports ou culture)"
      },{
        "id": 4,
        "text": "Bureaux"
      },{
        "id": 5,
        "text": "Espaces à usage collectif"
      },{
        "id": 6,
        "text": "Terminal croisiéristes"
      },{
        "id": 7,
        "text": "Musée Maritime de Nouvelle-Calédonie avec son pavillon flottant"
      }
    ]
  }, {
    "id": 5,
    "title": "Bâti",
    "description": "Une fois l’entrée nord re-aménagée, de manière temporaire puis de manière définitive, la partie nord du centre ville s’en verra\
    ...
    "map": "./images/survey-map-bati.png",
    "note": "Que pensez vous de la programmation des espaces bâtits que nous proposons?",
    "questions": [
      {
        "id": 1,
        "text": "Bâtiment multifonctionnel (École de danse, bureaux, hôtel, ...)"
