...
export default class Edit extends Component {
  ...
  _onDelete(e) {
    e.preventDefault();
    this.props.handleDelete(this.props.status.id);
  }

  _onSave(e) {
    e.preventDefault();
    const data = new FormData(e.currentTarget);
    this.props.handleSave(data, this.props.status.id);
  }
          ...
          <form encType='multipart/form-data' onSubmit={this.onSave} acceptCharset='UTF-8'>
            <div className='row'>
              ...
              <div className='input-field col s12 m12 l6'>
                ...
                {
                  this.props.error &&
                  <div className='error-message'>{this.props.error['statuses.start_date']}</div>
                }
              </div>
