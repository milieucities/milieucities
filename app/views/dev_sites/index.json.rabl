...
child(@dev_sites) {
  ...
  attributes :id, :devID, :featured, :title, :current_status, :status_date, :street, :address, :images, :description, :ward_name, :ward_num, :image_url, :hearts, :updated_at, :latitude, :longitude, :general_status
